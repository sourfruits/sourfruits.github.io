...
const LEARN_MORE_CARDS = [
  {
    ...
    body: `In 1951, Jorge Luis Borges wrote an essay titled <em>Kafka and His Precursors</em>, arguing that while works influence their successors, they also retroactively create their own precursors. A work's influence runs both forwards and backwards, "modifi[ying] our conception of the past, as it will modify the future."
